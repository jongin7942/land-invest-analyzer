...
# 1,200% 였다가 500%로 내렸다 - x100 단위 버그를 고치고 나서 603%·318% 같은
# 값이 통과하는 걸 봤다. 국내 아파트는 초고층 주상복합도 500%를 넘는 경우가
# 사실상 없다(1000% 이상은 순수 상업용). 이보다 높으면 여전히 대표 필지 하나만
# 잡힌 다중 필지 미포착으로 본다.
MAX_PLAUSIBLE_FAR = 5.0         # 500%
